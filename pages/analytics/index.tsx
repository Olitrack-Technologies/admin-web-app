...
import { Button, Card, Modal, Tabs } from "@mantine/core"
        ...
        <div>
          ...
          >
            ...
            <span className="text-[10px] font-medium">
              {change}% {isPositive ? "rise" : "fall"} this week
            </span>
          </div>
        </div>
    ...
    <Layout>
      <div className="p-6 space-y-6 max-h-[calc(100vh-56px)] overflow-y-auto">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-[16px] font-semibold text-slate-800">Analytics</h2>
          </div>
          <Button size="xs" color="teal" onClick={() => setExecReportModalOpen(true)}>
